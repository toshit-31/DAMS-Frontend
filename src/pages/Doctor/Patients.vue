      ...
      <v-container class="mt-5">
        ...
        <v-row>
          ...
          <v-col cols="12" v-if="patients.length != 0">
            <v-card v-if="terms.length" elevation="0" class="pa-5">
            ...
            <v-card v-for="p,i in patients" elevation="2" :key="i" class="pat-card my-4">
              <v-card-title class="ct">{{p.fullName}}<v-btn color="#6200ee" class="mx-5" text fab><v-icon>launch</v-icon></v-btn></v-card-title>
              ...
              <table class="mx-3">
                ...
                <tr>
                  ...
                  <td><v-chip color="#6200ee33">{{p.diagnosis[0].title}}</v-chip></td>
                </tr>
              </table>
            </v-card>
          </v-col>
